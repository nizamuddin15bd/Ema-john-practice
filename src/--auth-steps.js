 ...
 * 6.attach form handler and form submit handler
 ...
 * 11.create RequireAuth components ==> check user exists also tract user location
 * 10. In route wrap Protected Components by using auth components
*/
